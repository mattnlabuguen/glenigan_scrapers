...
from base.download import DownloadStrategy

class WandsworthGovUkDownloadStrategy(DownloadStrategy):
    def __init__(self):
        self.downloader = requests.Session()
        # self.downloader.proxies = {
        #     "http": "http://394130988c184284b8758d9588ee0084:@proxy.crawlera.com:8011/",
        #     "https": "http://394130988c184284b8758d9588ee0084:@proxy.crawlera.com:8011/",
        # }
    ...
    def get_first_page_data(self, viewstate:str, viewstate_generator:str, event_validation:str) -> str:
        ...
        default_params = f'__VIEWSTATE={quote_plus(viewstate)}&__VIEWSTATEGENERATOR={quote_plus(viewstate_generator)}&__EVENTVALIDATION={quote_plus(event_validation)}&txtApplicationNumber=&txtApplicantName=&txtAgentName=&cboStreetReferenceNumber=&txtProposal=&edrDateSelection=&cboWardCode=&cboParishCode=&cboApplicationTypeCode=&cboDevelopmentTypeCode=&cboStatusCode=&'
        params = {
    ...
    def get_search_result_data(self, soup:str, base_url:str) -> list:
        search_results = []
    ...
    def get_next_url(self, soup:str, base_url:str) -> str:
        next_url = None
